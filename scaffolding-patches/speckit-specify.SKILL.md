...
6. Follow this execution flow:
    ...
    6. Define Determinism Requirements (DR-001 hash stability across runs and `--threads 1,2,4` is mandatory; add milestone-specific DRs)
...
- Good: "Replay of the milestone fixture produces identical hashes at all checkpoints across `--threads 1,2,4`"
